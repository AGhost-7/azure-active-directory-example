...
assert(process.env.CLIENT_ID, 'CLIENT_ID must be specified')
assert(process.env.CLIENT_SECRET, 'CLIENT_SECRET must be specified')

// https://morgansimonsen.com/2015/10/27/how-to-find-the-guid-of-your-azure-ad-tenant/
assert(process.env.TENANT_ID, 'TENANT_ID must be specified')
...
export default {
	...
	database: {
		...
		logging: false,
		// this will create tables automatically. probably not a good idea
		// to use if this was a production app.
		synchronize: true
	},
  // referenced from:
  // https://github.com/AzureADQuickStarts/AppModelv2-WebApp-OpenIDConnect-nodejs/blob/master/config.js
	activeDirectory: {
    ...
    // Required, the reply URL registered in AAD for your app
		redirectUrl: process.env.REDIRECT_URL
			|| 'http://localhost:6540/authenticate/openid/return',
